...
import com.example.agrimart.Adapters.MessageAdapter
import com.example.agrimart.Class.MyClass
import com.example.agrimart.Model.Message
import com.example.agrimart.R
import com.example.agrimart.databinding.ActivityMessageBinding
...
class MessageActivity : AppCompatActivity() {
    ...
    private fun setPicAndName() {
        var database = FirebaseDatabase.getInstance().getReference("Farmer")
